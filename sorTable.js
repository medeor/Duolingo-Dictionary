    ...
    **/
    ...
    function removeTHClass(table, tableData) {
        ...
        Object.keys(tableElem).forEach(function(key) {
            ...
            tableElem[key].classList.remove("_2Zztm");
            tableElem[key].classList.remove("_3ZtOu");
            tableElem[key].classList.add("_2fZva");
        });
    }
    ...
    function setTHClass(elem, sortOrder) {
        if (sortOrder === 1) {
            ...
            elem.classList.add("_2Zztm");
        }else {
            elem.classList.add(config.cssDesc);
            elem.classList.add("_3ZtOu");
        }
    }
